...
class BoundingBox:
    ...
    def from_yolo(
        ...
        return BoundingBox(data[0], left, top, right, bottom)
...
class Keypoint:
    ...
    Constructors :
        `from_yolo(yolo_line: str, image_width: int, image_height: int)`:
    ...
    def from_yolo(
        ...
        Returns:
            A `BoundingBox` object containing the yolo_line's data.
        """
        bounding_box = BoundingBox.from_yolo(yolo_line, image_width, image_height)
